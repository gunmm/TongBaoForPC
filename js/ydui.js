/*! vue-ydui v0.4.4 by YDCSS (c) 2017 Licensed MIT */ ! function(t, e) {
	...
	return function(t) {
		...
		var k = function(t) {
			t.component(a.Layout.name, a.Layout), t.component(s.Button.name, s.Button), t.component(s.ButtonGroup.name, s.ButtonGroup), t.component(r.NavBar.name, r.NavBar), t.component(r.NavBarBackIcon.name, r.NavBarBackIcon), t.component(r.NavBarNextIcon.name, r.NavBarNextIcon), t.component(o.CellGroup.name, o.CellGroup), t.component(o.CellItem.name, o.CellItem), t.component(l.Switch.name, l.Switch), t.component(c.GridsItem.name, c.GridsItem), t.component(c.GridsGroup.name, c.GridsGroup), t.component(A.Icons.name, A.Icons), t.component(u.ListTheme.name, u.ListTheme), t.component(u.ListItem.name, u.ListItem), t.component(u.ListOther.name, u.ListOther), t.component(d.InfiniteScroll.name, d.InfiniteScroll), t.component(f.PullRefresh.name, f.PullRefresh), t.component(h.Badge.name, h.Badge), t.component(p.TabBar.name, p.TabBar), t.component(p.TabBarItem.name, p.TabBarItem), t.component(v.Tab.name, v.Tab), t.component(v.TabPanel.name, v.TabPanel), t.component(m.ScrollTab.name, m.ScrollTab), t.component(m.ScrollTabPanel.name, m.ScrollTabPanel), t.component(g.ActionSheet.name, g.ActionSheet), t.component(w.SendCode.name, w.SendCode), t.component(C.KeyBoard.name, C.KeyBoard), t.component(y.Slider.name, y.Slider), t.component(y.SliderItem.name, y.SliderItem), t.component(B.Spinner.name, B.Spinner), t.component(b.CitySelect.name, b.CitySelect), t.component(_.ProgressBar.name, _.ProgressBar), t.component(E.LazyImg.name, E.LazyImg), t.component(x.CountDown.name, x.CountDown), t.component(I.Rate.name, I.Rate), t.component(Q.TextArea.name, Q.TextArea), t.component(L.Popup.name, L.Popup), t.component(M.CountUp.name, M.CountUp), t.prototype.$dialog = {
				confirm: i.Confirm,
				alert: i.Alert,
				toast: i.Toast,
				notify: i.Notify,
